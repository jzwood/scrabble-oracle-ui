...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"geometry.js":[function(require,module,exports) {
...
function lineIntersect(_ref, _ref2, _ref3, _ref4) {
...
function xy2pp(pq, pc, e1, e2) {
  var pqInt = lineIntersect(pq, pc, e1, e2);
  var percentToEdge = mag(to(pc, pq)) / mag(to(pc, pqInt));
  var u = to(e1, e2);
  var percentAlongEdge = mag(to(e1, pqInt)) / mag(u);
  return [percentToEdge, percentAlongEdge];
}

function pp2xy(percentToEdge, percentAlongEdge, pc, e1, e2) {
  var u = to(e1, e2);
  var pqInt = plus(e1, scale(percentAlongEdge, u));
...
},{}]},{},["../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","geometry.js"], null)
//# sourceMappingURL=/geometry.0cd602de.js.map